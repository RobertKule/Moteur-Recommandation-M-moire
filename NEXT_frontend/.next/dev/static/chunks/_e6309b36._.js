    ...
    async request(endpoint, options = {}) {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                // Si erreur 401 (Unauthorized), nettoyer le token
                ...
                throw new Error(typeof errorData === 'object' ? errorData.detail || errorData.message || JSON.stringify(errorData) : errorData);
            }
...
//# sourceMappingURL=_e6309b36._.js.map